...
static DecodeStatus DecodePFPR128RegisterClass(MCInst &Inst, unsigned RegNo,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodePFPR64RegisterClass(MCInst &Inst, unsigned RegNo,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodePFPR32RegisterClass(MCInst &Inst, unsigned RegNo,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder);
static DecodeStatus DecodePFPR16RegisterClass(MCInst &Inst, unsigned RegNo,
                                              uint64_t Address,
                                              const MCDisassembler *Decoder);
...
static DecodeStatus DecodePFPR128RegisterClass(MCInst &Inst, unsigned RegNo,
  ...
  unsigned Register =
      AArch64MCRegisterClasses[AArch64::PFPR128RegClassID].getRegister(RegNo);
...
static DecodeStatus DecodePFPR64RegisterClass(MCInst &Inst, unsigned RegNo,
  ...
  unsigned Register =
      AArch64MCRegisterClasses[AArch64::PFPR64RegClassID].getRegister(RegNo);
  Inst.addOperand(MCOperand::createReg(Register));
  return Success;
}
...
static DecodeStatus DecodePFPR32RegisterClass(MCInst &Inst, unsigned RegNo,
  ...
  unsigned Register =
      AArch64MCRegisterClasses[AArch64::PFPR32RegClassID].getRegister(RegNo);
  Inst.addOperand(MCOperand::createReg(Register));
  return Success;
}
...
static DecodeStatus DecodePFPR16RegisterClass(MCInst &Inst, unsigned RegNo,
  ...
  unsigned Register =
      AArch64MCRegisterClasses[AArch64::PFPR16RegClassID].getRegister(RegNo);
  Inst.addOperand(MCOperand::createReg(Register));
  return Success;
}
