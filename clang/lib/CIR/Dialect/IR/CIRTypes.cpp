...
static mlir::ParseResult parseSignedness(mlir::AsmParser &parser, bool &isSigned);
static void printSignedness(mlir::AsmPrinter &printer, bool isSigned);
